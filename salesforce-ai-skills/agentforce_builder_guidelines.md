...
How the Agentforce Builder UI concepts map to `.agent` DSL, and when to use which authoring surface. Pair with **[agentforce-agent-script-reference.md](agentforce-agent-script-reference.md)**, **[agentforce_authoring_bundle_guide.md](agentforce_authoring_bundle_guide.md)**, and **[agentforce_script_guidelines.md](agentforce_script_guidelines.md)**.
...
**Workaround:** deploy a Bot-only override manifest immediately after every publish — see [agentforce_authoring_bundle_guide.md §8](agentforce_authoring_bundle_guide.md).
...
- Companion files in this skill set:
  - [Agent Script Canonical Reference](agentforce-agent-script-reference.md)
  - [Agentforce Authoring Bundle Lifecycle](agentforce_authoring_bundle_guide.md)
  - [Agentforce Script Authoring Guidelines](agentforce_script_guidelines.md)
