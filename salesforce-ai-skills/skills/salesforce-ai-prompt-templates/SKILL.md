---
name: salesforce-ai-prompt-templates
description: Production Salesforce AI skill for Creating copy-paste prompts for Salesforce review/implementation.
license: Apache-2.0
compatibility:
  - Claude Code
  - Claude Agents
...
## TRIGGER when
- The task involves Creating copy-paste prompts for Salesforce review/implementation.
...
- Also read: Global Development + component skill + Testing + Deployment.
...
Prompt templates must require file inspection, no deploy by default, and explicit output structure. Include placeholders for class/flow/agent identifiers and security checks.

## Upstream Salesforce Skill Patterns
- Agent Script recipe patterns distinguish fixed inputs, bound variable inputs, and LLM slot-filled inputs; choose the safest binding mode for prompt-backed actions.
- Prompt-template actions need explicit input/output contracts and deterministic downstream parsing rules when used by Apex or LWC.
- Use prompt templates for grounded language generation, not as a substitute for validation, permissions, or deterministic state transitions.
- When a prompt action feeds automation, define both machine-readable output and human-readable summary expectations, then test disagreement paths.
- Treat Prompt Builder metadata as deployable source: verify template API names, model/provider assumptions, merge fields, grounding sources, and consuming agent/action references.

## Examples
### Good example patterns
1. Prompt asks for CRUD/FLS + bulkification review for {className}.
2. Prompt asks Flow review for idempotency/fault paths on {flowName}.

### Bad examples / avoid
1. Prompt asks assistant to deploy immediately after code generation.
2. Prompt omits security/testing expectations entirely.
...
**Pair with:** [../salesforce-agentforce-script/SKILL.md](../salesforce-agentforce-script/SKILL.md) - [../salesforce-agentforce-authoring-bundle/SKILL.md](../salesforce-agentforce-authoring-bundle/SKILL.md) - [../salesforce-agentforce-script/SKILL.md](../salesforce-agentforce-script/SKILL.md) - [../salesforce-agentforce-builder/SKILL.md](../salesforce-agentforce-builder/SKILL.md).
...
4. Run the validate / publish commands from `../salesforce-agentforce-authoring-bundle/SKILL.md Section 4`.
...
subagent <subagent_a>:
   ...
   actions:
      # subagent-level definitions (see Section 4 Section 5 reasoning:
      instructions: ->
...
**Rules** (from `../salesforce-agentforce-script/SKILL.md Section 6`):
...
**Rules** (from `../salesforce-agentforce-script/SKILL.md Section 7 8`):
...
public with sharing class <ClassName> {
    ...
    * guardrail pattern (../salesforce-agentforce-script/SKILL.md Section 8 public class Response {
...
**Traps** (from `../salesforce-agentforce-authoring-bundle/SKILL.md Section 16`):
...
Server-invokes an `AgentforceEmployeeAgent` from Apex. IDs are embedded in the message text (NOT `sessionVariables` -- silently dropped per `../salesforce-agentforce-authoring-bundle/SKILL.md Section 13`).
...
- If the LWC also parses a colon-labeled summary, the JSON's `summary` field and the colon-labeled summary text MUST agree -- JSON drives automation, text drives humans (`../salesforce-agentforce-authoring-bundle/SKILL.md Section 16 row 8`).
...
**Rules** (from `../salesforce-agentforce-authoring-bundle/SKILL.md Section 16 row 7`):
...
|---|---|
| 1. Agent skeleton | `../salesforce-agentforce-script/SKILL.md Section 1 8` |
| 2. Constitution | `../salesforce-agentforce-script/SKILL.md Section 4` |
| 3. Variables | `../salesforce-agentforce-script/SKILL.md Section 6` + `../salesforce-agentforce-script/SKILL.md Section 5 11` |
| 4. Subagent | `../salesforce-agentforce-script/SKILL.md Section 8` + `../salesforce-agentforce-script/SKILL.md Section 7 8` |
| 5. Apex action | `../salesforce-agentforce-authoring-bundle/SKILL.md Section 13 16` + `../salesforce-apex/SKILL.md` |
| 6. Apex caller | `../salesforce-agentforce-authoring-bundle/SKILL.md Section 13` |
| 7. JSON contract | `../salesforce-agentforce-authoring-bundle/SKILL.md Section 14` |
| 8. LWC integration | `../salesforce-agentforce-authoring-bundle/SKILL.md Section 16 row 7-8` + `../salesforce-lwc/SKILL.md` |
| 9. Bot-meta override | `../salesforce-agentforce-authoring-bundle/SKILL.md Section 8` |
| 10. Test invoker | `../salesforce-agentforce-authoring-bundle/SKILL.md Section 12` + `../salesforce-observability/SKILL.md` |
...
- [../salesforce-agentforce-script/SKILL.md](../salesforce-agentforce-script/SKILL.md) -- DSL grammar (canonical)
- [../salesforce-agentforce-authoring-bundle/SKILL.md](../salesforce-agentforce-authoring-bundle/SKILL.md) -- lifecycle, deploy/publish, Bot-meta override, Apex caller
- [../salesforce-agentforce-script/SKILL.md](../salesforce-agentforce-script/SKILL.md) -- authoring style, constitution, condition-based reasoning
- [../salesforce-agentforce-builder/SKILL.md](../salesforce-agentforce-builder/SKILL.md) -- Builder UI " DSL parity
- [../salesforce-apex/SKILL.md](../salesforce-apex/SKILL.md) -- Apex action class standards
- [../salesforce-lwc/SKILL.md](../salesforce-lwc/SKILL.md) -- LWC parser standards
- [../salesforce-observability/SKILL.md](../salesforce-observability/SKILL.md) -- `AppLogger`, correlation IDs
